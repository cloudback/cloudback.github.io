...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.24bc72a0fb7013523de720bfc41fb97b5281e918791c6b05c1dd179cbffe54be.js',function(){input.required=false;search();});}
