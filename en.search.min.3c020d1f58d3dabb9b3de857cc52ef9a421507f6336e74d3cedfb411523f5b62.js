...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5eabadb028b528687e6cb0fa1621a6d3b3a70fcef1d02bfd66465c170180016e.js',function(){input.required=false;search();});}
