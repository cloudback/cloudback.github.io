...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.00c63b3ef70f96d1094f84ad685b8fc141e2fe60c33a74d7329aba143699cd89.js',function(){input.required=false;search();});}
