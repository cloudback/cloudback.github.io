...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.792a9561beedac4585fc0decebfbf59adb173dffcdc9f177912c3e57d97b6782.js',function(){input.required=false;search();});}
