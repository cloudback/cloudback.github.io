...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.5bd6c899db01fbe1a43507c555df59b78912fa720bee27a33f703b3e66ab5d3e.js',function(){input.required=false;search();});}
