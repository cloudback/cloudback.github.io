...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/flexsearch.min.js');loadScript('/en.search-data.min.b1cf39a494f30a9c293eec1201c3140a9b70c87a34237531c43000a597eefe7e.js',function(){input.required=false;search();});}
